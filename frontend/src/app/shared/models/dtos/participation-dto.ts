...
export const fromParticipation = (participation: Participation): ParticipationDto => {
    return {
        id: participation.id ? { appointment_id: participation.id.appointmentId, customer_id: participation.id.customerId } : undefined,

...
export const fromParticipationDto = (participation: ParticipationDto): Participation  => {
    return {
        id: participation.id ? { appointmentId: participation.id.appointment_id, customerId: participation.id.customer_id } : undefined,
